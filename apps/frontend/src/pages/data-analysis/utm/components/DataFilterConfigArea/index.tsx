...
import UtmDimensionSelector from "../UtmDimensionSelector"
import UtmMetricSelector from "../UtmMetricSelector"
import UtmValueFilter from "../UtmValueFilter"
...
function DataFilterConfigArea() {
  ...
  const submit = useCallback(async () => {
    ...
    dispatch.dataAnalysisUtmModel.submitQuery()
