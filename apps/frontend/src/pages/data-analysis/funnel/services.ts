import { IFunnelAnalysisReq, IFunnelAnalysisRes, IQueryDownloadTaskReq, IQueryDownloadTaskRes, ISubmitDownloadTaskReq, ISubmitDownloadTaskRes } from "@probe-x/shared-types/src"
...
export function submitDownloadTask(data: ISubmitDownloadTaskReq) {
  return request<ISubmitDownloadTaskRes>({
    url: '/data-analysis/funnel/download',
    method: 'post',
    data,
  })
}
...
export function queryDownloadTask(data: IQueryDownloadTaskReq) {
  return request<IQueryDownloadTaskRes>({
    url: '/data-analysis/funnel/download/task',
    method: 'post',
    data,
  })
}
