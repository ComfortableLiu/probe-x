...
function GuideIndex() {
  ...
  const categories = [
    {
      ...
      items: [
        ...
        { name: '自由分析', path: '/guide/data-analysis/free' },
  ...
  return (
    <div className={styles.guideContent}>
      {/* 系统概述 */}
      <Card style={{ marginBottom: 32, background: 'linear-gradient(135deg, #667eea 0%, #764ba2 100%)', border: 'none' }}>
        <div style={{ color: '#fff' }}>
            ...
            <Col xs={24} sm={12} lg={6} key={index}>
              <Card className={styles.featureCard} hoverable>
                <Space direction="vertical" size="middle" style={{ width: '100%', textAlign: 'center' }}>
                  ...
                  <Paragraph style={{ margin: 0, color: '#666', lineHeight: 1.6, fontSize: 14 }}>
                    {feature.description}
                  </Paragraph>
                </Space>
              </Card>
      ...
      <Card style={{ marginBottom: 32 }}>
        ...
        <ul style={{ fontSize: 15, lineHeight: 2, color: '#666', paddingLeft: 24 }}>
        ...
        <Paragraph style={{ fontSize: 15, lineHeight: 1.8, color: '#666', marginTop: 16 }}>
